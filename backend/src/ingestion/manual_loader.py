...
We assign global identity documents (resume.md, about-me.md, faq.md) to a
reserved project namespace "__global__" to avoid duplicating identity
...
def load_manual_documents(project_name: str, knowledge_dir: Path) -> List[Document]:
    """
    Loads manual Markdown documents for a project and global identity files.
    
    1. Reads global identity files in the root knowledge_dir (resume.md, about-me.md, faq.md)
       and assigns them project = "__global__".
    2. Reads project-specific files in knowledge_dir / project_name recursively
    ...
    # We only look at files directly in the root of knowledge_dir
